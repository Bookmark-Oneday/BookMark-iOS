//
//  BottomSheetHistoryViewController.swift
//  BookMark
//
//  Created by BoMin on 2023/05/25.
//

import UIKit

final class BottomSheetHistoryViewController: UIViewController {
    ...
    private func setupViews() {
        ...
        self.deleteButton.setTitle("모든 기록 삭제", size: 16, weight: .w500, color: UIColor(Hex: 0xFF0F0F))
    }
